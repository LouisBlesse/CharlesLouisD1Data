// D1DataStruct.cpp : Ce fichier contient la fonction 'main'. L'exécution du programme commence et se termine à cet endroit.
//
...
int main()
{
    ...
    Pile<int> p(5);
    p.empiler(8);
    std::cout << "\nLa taille est "<<p.taille();
    std::cout << "\nLe sommet est "<<p.sommet();
    std::cout << "\nLa valeur est "<<p.tab[p.sommetPile];
}*/
